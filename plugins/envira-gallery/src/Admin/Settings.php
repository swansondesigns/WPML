...
class Settings {
	...
	public function maybe_fix_migration() {
		...
		if ( isset( $_POST['envira-serialization-nonce'] ) && ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['envira-serialization-nonce'] ) ), 'envira-serialization-nonce' ) ) {
			return;
		}
